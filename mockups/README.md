...
| E | `3e-mar-de-papel.html` | **Mar de papel** — el teatro mezclado con el diseño de referencia del cliente: fotos de la doctora protagonistas (provisionales, generadas), stickers del mural marino con borde blanco, estructura de la referencia (servicios, conoce a la doctora, dúo nutrición/pediatría, recursos, testimonios) y el **sapo tejido del consultorio como mascota oficial** (nombre por definir) presentando los «DalyTips». Fotos provisionales en `assets/3e/`. |
