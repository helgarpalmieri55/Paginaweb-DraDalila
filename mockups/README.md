...
|---|---------|------------------|
| 1 | `1-mundo-de-juego.html` | **Mundo de juego** — alusiva a la pediatría, como un cuento infantil: cielo, sol, colinas y los colores del logo en tono lúdico. |
...
| E | `3e-mar-de-papel.html` | **Mar de papel** — fusión de las dos referencias del cliente con la UI del teatro de papel: hero con la **doctora abrazando a Pepe** (foto real recortada sobre mancha rosa) y una notita de papel «Hagamos que su historia sea saludable»; los **stickers exactos del consultorio** y burbujas ritmando los márgenes de cada sección; **bandas de olas de cartulina** con sombra entre capas separando zonas crema y agua clara; 6 servicios, conoce a la doctora, dúo nutrición/pediatría, **conoce el consultorio** (fotos reales con cinta washi), **tres funciones en cartelera** (blog), testimonios, banda de contacto con foto y footer morado con el lema «Pequeñas vidas, grandes historias». Fotos reales de la doctora recortadas de la referencia (`assets/3e/fotos/`). Testimonios y datos de contacto provienen del material de referencia y se validarán antes de publicar. |
...
- Todas comparten las secciones del mapa del sitio de la propuesta: presentación y credenciales, cursos destacados (Hotmart), últimos artículos del blog, testimonios, citas (presencial/virtual con precios COP/USD) y contacto, más botón flotante de WhatsApp y aviso médico.
- El logo en `assets/` proviene del PDF oficial de entrega final (`Logo A finales.pdf`, diseño de Luz Angarita); cada PNG lleva su procedencia embebida (chunk `impeccable:prompt`).
- Son maquetas de diseño, no el sitio final: el sitio se construirá en WordPress sobre la dirección elegida, con dos rondas de ajustes incluidas.
