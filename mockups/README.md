...
| E | `3e-mar-de-papel.html` | **Mar de papel** — reproducción fiel del diseño de referencia entregado por el cliente: misma estructura (hero, 6 servicios, conoce a la doctora, dúo nutrición/pediatría, recursos, testimonios, contacto, footer morado), tipografía redondeada, paleta crema/rosa/lila, **fotos reales de la doctora** y **stickers exactos del consultorio** (todos recortados de esa imagen, en `assets/3e/`), con toques ligeros de teatro de papel: telón festón, olas de cartulina con sombra, grano de papel y **Pepe**, el sapo de peluche real, como mascota en la banda de contacto. Testimonios y datos de contacto provienen del material de referencia y se validarán antes de publicar. |
