...
/* -------- CONFIGURACIÓN --------
   En WordPress estos datos se editan en Ajustes → Datos del consultorio, y
   llegan aquí en window.DALILA_CONFIG. Los valores de abajo son el respaldo
   por si el tema corre suelto, fuera de WordPress. */
const CONFIG = Object.assign({
  ...
  precioPresencial: '$180.000',
  precioVirtual: '45 USD',
  mostrarPrecios: true,
  mostrarPepe: true,
  redes: { instagram: 'https://www.instagram.com/dra.dalilapenaranda/' },
  hotmart: { complementaria: '', lonchera: '', habitos: '', escuela: '' }
}, window.DALILA_CONFIG || {});
